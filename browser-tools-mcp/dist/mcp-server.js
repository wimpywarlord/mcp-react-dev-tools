...
function getDefaultServerPort() {
    ...
    try {
        const portFilePath = path_1.default.join(__dirname, ".port");
        if (fs_1.default.existsSync(portFilePath)) {
            const port = parseInt(fs_1.default.readFileSync(portFilePath, "utf8").trim(), 10);
...
server.tool("runAuditMode", "Run audit mode to optimize our application for SEO, accessibility and performance", async () => ({
    content: [
        {
            type: "text",
            text: `
